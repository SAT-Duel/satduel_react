...
function profileToUserUpdates(profile) {
    return {
        ...
        grade: profile.grade,
        grade_selected: profile.onboarding?.grade_selected,
        username_finalized: profile.onboarding?.username_finalized,
        is_premium: profile.is_premium,
        avatar: profile.avatar,
        avatar_icon: profile.avatar_icon,
        onboarding_required: profile.onboarding?.required,
        sat_exam_date: profile.onboarding?.sat_exam_date,
        sat_exam_date_selected: profile.onboarding?.sat_exam_date_selected,
