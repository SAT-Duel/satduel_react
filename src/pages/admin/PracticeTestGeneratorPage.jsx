...
import {ArrowLeft, Check, ClipboardList, Copy, Save, Sparkles} from 'lucide-react';
import api from '../../components/api';
import RenderWithMath from '../../components/RenderWithMath';
import withAuth from '../../hoc/withAuth';
import {Button, Card, Field, Input, PageContainer, Select, Textarea} from '../../components/ui';
...
function parseModelOutput(raw, expectedCount) {
    ...
    const required = ['question', 'answer', 'difficulty', 'question_type', 'explanation', 'is_pretest'];
    ...
    return (
        <details className="rounded-2xl border border-slate-200 bg-white px-4 py-3">
            <summary className="flex cursor-pointer list-none flex-wrap items-center gap-2 text-sm font-black text-slate-800">
                ...
                {question.is_pretest && <span className="rounded-full bg-amber-50 px-2 py-1 text-xs text-amber-700">Pretest</span>}
...
function PracticeTestGeneratorPage() {
    ...
    const summary = useMemo(() => {
        ...
        return {
            pretest: questions.filter((question) => question.is_pretest).length,
                ...
                <section className="mb-8">
                    <Card className="mb-4 p-5 sm:p-6">
                        ...
                        <div className="mt-4 flex flex-wrap gap-2 text-xs font-black">
                            ...
                            <span className="rounded-full bg-amber-50 px-3 py-1.5 text-amber-700">{summary.pretest} pretest</span>
